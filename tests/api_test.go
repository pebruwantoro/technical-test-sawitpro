...
func getTestCases() []TestCase {
	return []TestCase{
		//----- Test for API
		{
			Name: "Test Post Estate - Success",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(10, 10),
					Expect:  ExpectNewEstateOk(),
				},
			},
		},
		{
			Name: "Test Post Estate - Error Bad Request Because Length Out of Range",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(-10, 10),
		...
		{
			Name: "Test Post Estate - Error Bad Request Because Width Out of Range",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(10, -10),
					Expect:  ExpectBadRequest(),
		...
		{
			Name: "Test Post Estate Id Tree - Success",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(10, 10),
					Expect:  ExpectNewEstateOk(),
				...
				{
					Request: SendRequestNewTree(10, 2, 1),
					Expect:  ExpectNewTreeOk(),
				},
			},
		},
		{
			Name: "Test Post Estate Id Tree - Error Bad Request Because Height Out of Range",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(10, 10),
					Expect:  ExpectNewEstateOk(),
				...
				{
					Request: SendRequestNewTree(10000, 1, 3),
					Expect:  ExpectBadRequest(),
				},
			},
		},
		{
			Name: "Test Post Estate Id Tree - Error Bad Request Because X Out of Range",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(10, 10),
					Expect:  ExpectNewEstateOk(),
				...
				{
					Request: SendRequestNewTree(10, -1, 1),
					Expect:  ExpectBadRequest(),
				},
			},
		},
		{
			Name: "Test Post Estate Id Tree - Error Bad Request Because Y Out of Range",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(10, 10),
					Expect:  ExpectNewEstateOk(),
		...
		{
			Name: "Test Get Estate Id Stats - Success",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(10, 10),
					Expect:  ExpectNewEstateOk(),
				...
				{
					Request: SendRequestNewTree(20, 5, 6),
					Expect:  ExpectNewTreeOk(),
				},
				{
					Request: SendRequestNewTree(25, 4, 3),
					Expect:  ExpectNewTreeOk(),
				},
				{
					Request: SendRequestGetStats(),
					Expect:  ExpectGetStatsOk(2, 20, 25, 22),
				},
			},
		},
		{
			Name: "Test Get Estate Id Stats - Success Get Data 0 Value",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(10, 10),
					Expect:  ExpectNewEstateOk(),
				...
				{
					Request: SendRequestGetStats(),
					Expect:  ExpectGetStatsOk(0, 0, 0, 0),
				},
			},
		},
		{
			Name: "Test Get Estate Id Drone Plan - Success",
			Steps: []TestCaseStep{
				{
					Request: SendRequestNewEstate(10, 10),
					Expect:  ExpectNewEstateOk(),
				...
				{
					Request: SendRequestGetDronePlan(0),
					Expect:  ExpectGetDronePlanOk(225),
				},
			},
		},
		{
			Name: "Test Get Estate Id Drone Plan - Error Estate Not Found",
			Steps: []TestCaseStep{
				{
					Request: SendRequestGetDronePlan(0),
					Expect:  ExpectNotFound(),
					Result:  map[string]any{"id": uuid.New().String()},
				},
			},
		},
	}
